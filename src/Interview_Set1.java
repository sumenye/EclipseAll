...
public class Interview_Set1 {
	...
	public static void main(String[] args) {
		...
		//System.out.println(swapFirstLastCharacters6("Ozkan"));
		//System.out.println(reverseString5("Cyber"));
		//System.out.println(removexX4("x"));
		//System.out.println(factorial3(4));
		//System.out.println(countOfWord2("Ozkan",5,"/"));
		//System.out.println(countJava1("javakjavaJAVAJavaufkajsdkjava"));
